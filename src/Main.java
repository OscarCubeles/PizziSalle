...
/**
 *
 * The goal of this project is to implement different design patters with java using MVC as architectural pattern
 * The design patterns used are:
 * - Singleton: To make sure that the data read from the json files is only in one object and not duplicated.
 *              Also, to ease its access from different classes.
 ...
 * - DAO (Data Access Object): To define how the program can access the data in the json files
